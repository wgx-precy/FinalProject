...
--
-- Host: localhost
-- Generation Time: May 05, 2013 at 07:27 PM
...
CREATE TABLE IF NOT EXISTS `notes` (
  ...
  `uid` int(10) unsigned NOT NULL,
  `nloc_x` float NOT NULL,
  `nloc_y` float NOT NULL,
...
(1, 1, 30.0101, 30, '2013-04-20 23:11:07', 'public', 0, 15, 'this is user1''s note1', 2, 'www.user1note.com', '2013-04-01', '2013-04-15', 0, '0', '0', 0, '10:10:10', '13:13:13'),
...
CREATE TABLE IF NOT EXISTS `requests` (
  ...
  `fid` int(10) unsigned NOT NULL,
  `uid` int(10) unsigned NOT NULL,
  `status` enum('friend','follow','request') DEFAULT 'request',
  KEY `id` (`id`)
...
INSERT INTO `requests` (`id`, `fid`, `uid`, `status`) VALUES
(1, 1, 2, 'request'),
(2, 1, 3, 'request'),
(3, 2, 6, 'friend'),
(4, 3, 6, 'friend'),
...
INSERT INTO `users` (`id`, `username`, `password`, `uemail`, `first_name`, `last_name`, `credit`, `create_time`) VALUES
...
(6, '12345@iclud.com', '123', '12345@iclud.com', 'xie', 'hong', 0, '2013-05-02 21:42:43');
...
INSERT INTO `users_filters` (`id`, `uid`, `datestart`, `dateend`, `repeat1`, `week1`, `week2`, `repeat2`, `timestart`, `timeend`, `state`, `district`) VALUES
...
(4, 6, '2013-04-15', '2013-04-20', 1, '0', '0', 0, '10:10:10', '13:13:13', '', '3074 Blue Fox Landing'),
(5, 3, '2013-04-15', '2013-04-20', 1, '0', '0', 0, '10:10:10', '13:13:13', '', '422 Fulton Street'),
(6, 6, '0000-00-00', '0000-00-00', 0, '1', '7', 1, '10:10:10', '13:13:13', '', '422 Fulton Street'),
...
(6, 40.7297, -73.9969, '2013-05-04 19:46:00'),
(6, 40.7297, -73.9969, '2013-05-04 21:39:44'),
(6, 40.7297, -73.9969, '2013-05-04 21:59:56'),
(6, 40.7297, -73.9969, '2013-05-04 22:04:01'),
(6, 40.7297, -73.9969, '2013-05-04 22:05:00'),
(6, 40.7297, -73.9969, '2013-05-04 22:14:55'),
(1, 40.7297, -73.9969, '2013-05-04 22:17:43'),
(6, 40.7297, -73.9969, '2013-05-05 14:49:13'),
(6, 40.7297, -73.9969, '2013-05-05 15:41:54'),
(6, 40.7298, -73.9969, '2013-05-05 17:29:49');
